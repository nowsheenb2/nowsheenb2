...
write.csv(sig.limma,file ="DEMRNA_ARRAY_2.csv")
...
write_csv(downregulated_mrna, "downregulated_ARRAYMRNA_2.csv")
...
write_csv(upregulated_mrna, "upregulated_ARRAYMRNA_2.csv")
...
diseased_vs_healthy %>%
  ...
  scale_x_continuous(breaks = c(seq(-10, 10, 2)),       
                     limits = c(-10, 10))+
  labs(title = "Volcano plot of differentially expressed mRNA in GSE30784",
       x = "log2(Fold Change)",
       y = "-log10(Adj.P.Value)",
       colour = "Expression \nchange") +
