...
write.csv(sig.limma,file ="DEMRNA_ARRAY.csv")
...
write_csv(downregulated_mrna, "downregulated_ARRAYMRNA.csv")
...
write_csv(upregulated_mrna, "upregulated_ARRAYMRNA.csv")
...
diseased_vs_healthy %>%
  ...
  scale_x_continuous(breaks = c(seq(-10, 10, 2)),       
                     limits = c(-10, 10))+
  labs(title = "Volcano plot of differentially expressed mRNA in GSE74530",
       x = "log2(Fold Change)",
       y = "-log10(Adj.P.Value)",
       colour = "Expression \nchange") +
